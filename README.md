# Discord-client-for-Powershell-only-receptor-
...
4. To get your Token: Open Discord, press F12 (or Ctrl + Shift + I), go to the Console tab and paste this code: (webpackChunkdiscord_app.push([[''],{},e=>{m=[];for(let c in e.c)m.push(e.c[c])}]),m).find(m=>m?.exports?.default?.getToken!==void 0).exports.default.getToken()
...
Support: If you have any issues, contact me on Discord: wyxnar.
